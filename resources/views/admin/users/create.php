...
unset($_SESSION['form_data']); // Limpa dados após uso
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title><?= $title ?? 'Criar Usuário' ?> - Di Conservas Admin</title>
                        ...
                        <div class="card form-card">
                            <div class="card-header bg-white">
                                <h5 class="card-title mb-0">
                                    <i class="bi bi-person-plus-fill"></i> Dados do Usuário
                                </h5>
                            </div>
                            <div class="card-body">
                                            ...
                                            <?php if (!empty($holes)): ?>
                                                <?php foreach ($holes as $hole): ?>
                                                    <option value="<?= $hole['id'] ?>" 
                                                            <?= ($formData['hole_id'] ?? '') == $hole['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="card form-card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled small text-muted">
                                    <li><i class="bi bi-check text-success"></i> Mínimo 6 caracteres</li>
                                    <li><i class="bi bi-info-circle"></i> Será criptografada automaticamente</li>
                                </ul>
                            </div>
                        </div>
                    </div>
